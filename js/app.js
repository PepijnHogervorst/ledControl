var websocketclient = {
    ...
    'connect': function () {
        ...
        var host = "192.168.178.34"//$('#InputUrl').val();
        var port = 8080;//parseInt($('#InputPort').val(), 10);
        var clientId = "Webclient-";//$('#InputClientID').val();
        var username = "User";//$('#userInput').val();
        var password = "";
    ...
    'onConnect': function () {
		...
		websocketclient.subscribe("ESP8266/#", 1);
		websocketclient.subscribe("debug", 1);
		
		websocketclient.publish("debug", "Hello from LED control world", 1, false);
    },
    ...
    'onMessageArrived': function (message) {
			...
			console.log("Message received from topic "+topic+": "+content);
			
			switch(topic)
			{
				case "cocktail/settings":
